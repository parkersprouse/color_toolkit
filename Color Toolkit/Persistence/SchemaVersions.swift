...
/// ## Adding a version
///
/// 1. Copy the model types into a `ColorToolkitSchemaV2` enum, edited.
/// 2. Add it to ``ColorToolkitMigrationPlan/schemas``, newest last.
...
enum ColorToolkitSchemaV1: VersionedSchema {
...
enum ColorToolkitMigrationPlan: SchemaMigrationPlan {
  nonisolated static var schemas: [any VersionedSchema.Type] {
    [ColorToolkitSchemaV1.self]
  }
