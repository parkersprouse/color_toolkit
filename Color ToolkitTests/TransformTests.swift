...
struct ShadeRampTests {
    ...
    func chromaTapers() {
        ...
        #expect(chromas.first! < chromas[middle])
        #expect(chromas.last! < chromas[middle])
    ...
    func extremeBaseKeepsItsPlace() {
        ...
        #expect(lightnesses.first! <= 0.99 + 1e-12, "the ramp invented lightness above the base")
    }
